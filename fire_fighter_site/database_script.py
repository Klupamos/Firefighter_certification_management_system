...
c2 = Candidate.objects.get_or_create(email_address = "B@C.com", first_name = "blue", middle_initial = "Q", last_name = "Campell", phone_number = 9074565588, street_address = "quiggly ln", city_name = "Fairbanks", postal_code = 45337, state_abrv = "AK")[0]
c2.set_password("moocow")
c2.Add_Requirements(req1, req3)
c2.Add_Certifications(cert4)
